...
COLLECTION_TIME = 2.0
TRANSPORT_TIME = 0.337
MTAS_MEASURE_TIME = 25.00
LASER_TIME = 0.2
...
INPUT["HPGe Integration Time"] = 7553.1
...
#INPUT["Gamma Areas"] = [320.0, 3256.0, 146.0]
#INPUT["Gamma Areas"] = [784.0-320.0, 8098.0-3256.0, 475.0-146.0]
INPUT["Gamma Areas"] = [10737.0,127448.0,6803.0]
