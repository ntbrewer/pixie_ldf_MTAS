...
# this is: Collection time + move time + measure time + move time + laser time
COLLECTION_TIME = 0.7
TRANSPORT_TIME = 0.335
MTAS_MEASURE_TIME = 1.4
LASER_TIME = 0.2
...
INPUT["HPGe Integration Time"] = 420.0
# stores the energies (in MeV) of the gammas of interest
INPUT["Gamma Energies"] = [0.204, 0.3287, 0.35201, 0.769]
# stores the intensities of the gammas of interest
# if the intensity is 2.56% give 0.0256
INPUT["Gamma Branchings"] = [0.151844, 0.09367, 0.493, 0.04437]
# stores the counts of the peaks of interest
INPUT["Gamma Areas"] = [11784.0, 5441.0, 24302.0, 1096.0]
