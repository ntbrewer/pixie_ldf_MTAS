...
/****Added for SVP / NTB ****/
    double TrcQDC;
    int MaxValue,SatLen;
    double StdDevBaseline,AveBaseline, AveBaselinePost;
    int Phase; 
    unsigned int MaxPos;
    int tRegion;

    void SetSatLen(int a) {SatLen=a;}       /**< Set the number of Saturated Channels NTB*/
    ...
    void SetAveBaselinePost(double a)  {AveBaselinePost=a;}        /**< Set the Average of the Post Pulse baseline from Trace*/
    void SetPhase(int a)    {Phase=a;}          /**< Set the Phase from Trace*/
    ...
    int GetSatLen() const {return SatLen;}       /**< Return the Maximum Value from Trace*/
    ...
    double GetAveBaselinePost() const {return AveBaselinePost;}           /**< Return the Average of the Baseline from Trace*/
    int GetPhase() const {return Phase;}       /**< Return the phase from Trace*/
    double GetHighResTime() const {return time + Phase;}  /**< Return the time + phase*/
